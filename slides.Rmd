...
* [Hilary Parker's famous blog post _Writing an R package from scratch_](https://hilaryparker.com/2014/04/29/writing-an-r-package-from-scratch/)
  
* [this pictorial by Matthew J Denny](http://www.mjdenny.com/R_Package_Pictorial.html)

* http://happygitwithr.com/

* Get closer to developer bliss! http://usethis.r-lib.org/articles/articles/usethis-setup.html
